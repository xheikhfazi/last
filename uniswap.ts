...
import {CurrencyAmount,MaxUint256,Token,TradeType,} from "@uniswap/sdk-core";
...
const provider = new ethers.providers.JsonRpcProvider("https://mainnet.infura.io/v3/269e68ee0f9c41c283017f6764ca2816");
...
export default async function Uniswap_Price(): Promise<number> {
  ...
  let panBuy = await pan.methods.getAmountsOut(5000000000,['0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48','0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2']).call();
  let panbuy = panBuy[1]/1e18;

  let sushiBuy = await sushi.methods.getAmountsOut(5000000000,['0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48','0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2']).call();
  ...
  let UsushiSell = await sushi.methods.getAmountsOut(am,['0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2','0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48']).call();
  let Usushisell=UsushiSell[1]/1e6;
  console.log("Buy UNI****Sushi Sell Amount: " + Usushisell);

  let UpanSell = await pan.methods.getAmountsOut(am,['0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2','0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48']).call();
  ...
  let SpanSell = await pan.methods.getAmountsOut(am2,['0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2','0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48']).call();
 ...
 let SUnisell =SUniSell/1e6;
  ...
  let PsushiSell = await pan.methods.getAmountsOut(am3,['0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2','0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48']).call();
 ...
 let PUnisell =PUniSell/1e6;
  ...
  if(Usushisell > 5000 || Upansell > 5000 || Spansell > 5000 || SUnisell > 5000 || Psushisell > 5000 || PUnisell > 5000)
  {
